...
var _componentsOverlay = require('./components/Overlay');

var _componentsOverlay2 = _interopRequireDefault(_componentsOverlay);

var _componentsOverlayTrigger = require('./components/OverlayTrigger');

var _componentsOverlayTrigger2 = _interopRequireDefault(_componentsOverlayTrigger);
...
var Components = {
  ...
  Button: _componentsButton2['default'],
  ...
  Overlay: _componentsOverlay2['default'],
  OverlayTrigger: _componentsOverlayTrigger2['default'],
  Tooltip: _componentsTooltip2['default'],
  Modal: _componentsModal2['default'],
