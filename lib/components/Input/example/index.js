...
var InputExample = (function (_React$Component) {
  ...
  function InputExample() {
    ...
    this._handleResetExampleChange = function (event) {
      _this.setState({ myinput: event.target.value });
    };

    this._handleReset = function () {
      console.log('Reset');
      _this.setState({ myinput: '' });
    };
  }
  ...
  _createClass(InputExample, [{
    ...
    value: function render() {
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(_2['default'], { label: 'Test input with reset',
