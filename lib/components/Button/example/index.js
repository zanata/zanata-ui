  ...
  return (0, _reactStampit2['default'])(React, {
    ...
    render: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(
          _2['default'],
          { className: 'mr1', size: 2 },
          'Size 2 button'
        ),
        React.createElement(
          _2['default'],
          { className: 'mr1' },
          React.createElement(_Icon2['default'], { name: 'trash', className: 'mr1/8' }),
          'Default button with Icon'
        ),
        React.createElement(
          _2['default'],
          { link: true, kind: 'danger', className: 'mr1' },
          React.createElement(_Icon2['default'], { name: 'trash', className: 'mr1/8' }),
          'Danger Link button with Icon'
        ),
        React.createElement(
          _2['default'],
          { link: true, kind: 'success', className: 'mr1', onClick: function () {
              return _this2._handleClick();
            }, loading: loading },
          React.createElement(_Icon2['default'], { name: 'notification', className: 'mr1/8' }),
        ...
        React.createElement(
          _2['default'],
          { className: 'mr1', onClick: function () {
              return _this2._handleClick();
            }, loading: loading },
