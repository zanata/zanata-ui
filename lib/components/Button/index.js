...
var ButtonFactory = function ButtonFactory(React) {
  ...
  return (0, _reactStampit2['default'])(React, {
    ...
    render: function render() {
      ...
      var linkClasses = (0, _classnames2['default'])(className, classes['default'], classes.link['default'], disable && classes.disabled, classes.link.kind[kind], disable && classes.states.disabled, interativeState === 'active' && classes.link.states.active, interativeState === 'hovered' && classes.link.states.hover, interativeState === 'focused' && classes.link.states.focus);
