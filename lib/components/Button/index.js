...
var ButtonFactory = function ButtonFactory(React) {
  ...
  return (0, _reactStampit2['default'])(React, {
    ...
    render: function render() {
      ...
      var is = this.getState(loading);
      var buttonClasses = (0, _classnames2['default'])(className, classes['default'], classes.button['default'], padding || classes.button.size[size], bdrs || classes.button.bdrs, classes.button.kind[kind], is.disabled && classes.states.disabled, is.disabled && classes.button.states.disabled, is.active && classes.button.states.active, is.hovered && classes.button.states.hover, is.focused && classes.button.states.focus, is['default'] && classes.button.states['default']);
      var linkClasses = (0, _classnames2['default'])(className, classes['default'], classes.link['default'], padding, classes.link.kind[kind], is.disabled && classes.states.disabled, is.disabled && classes.link.states.disabled, is.active && classes.link.states.active, is.hovered && classes.link.states.hover, is.focused && classes.link.states.focus);
      var buttonInteractiveClasses = (0, _classnames2['default'])(classes.button.interactive['default'], bdrs || classes.button.bdrs, is.disabled && classes.button.interactive.states.disabled, is.active && classes.button.interactive.states.active, is.hovered && classes.button.interactive.states.hover, is.focused && classes.button.interactive.states.focus, is['default'] && classes.button.interactive.states['default']);
      var buttonInteractive = link ? null : React.createElement('span', { className: buttonInteractiveClasses });
      ...
      var buttonLoaderSize = parseInt(size, 10) + 4;
      var buttonLoader = React.createElement(
        ...
        function (interpolated) {
          return React.createElement(
            'span',
            { className: classes.loader['default'],
              style: {
                transform: 'translateY(' + interpolated.val + '%)',
                WebkitTransform: 'translateY(' + interpolated.val + '%)',
                opacity: 1
