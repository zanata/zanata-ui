...
var Tooltip = (function (_React$Component) {
  ...
  _createClass(Tooltip, [{
    ...
    value: function render() {
      ...
      var props = _objectWithoutProperties(_props, ['placement', 'title', 'inverse', 'positionLeft', 'positionTop', 'arrowOffsetLeft', 'arrowOffsetTop', 'className', 'style', 'children']);
      ...
      var tooltipClasses = (0, _classnames2['default'])(className, 'ffsans posa z4 fzn1', placement);
      ...
      var tooltipTitleClasses = (0, _classnames2['default'])('ttu fzn2', {
        'csec70': !inverse,
        'cwhite70a': inverse
      });
    ...
    value: {
       ...
       * @required
       */
      id: (0, _reactPropTypes.isRequiredForA11y)(_react2['default'].PropTypes.oneOfType([_react2['default'].PropTypes.string, _react2['default'].PropTypes.number])),
      /**
