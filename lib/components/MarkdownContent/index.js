...
var MarkdownContent = (function (_React$Component) {
  ...
  function MarkdownContent() {
    ...
    this.renderedMarkdown = function () {
      return { __html: (0, _marked2['default'])(_this.props.markdown, { renderer: renderer }) };
    };
  }
  ...
  _createClass(MarkdownContent, [{
    ...
    value: function render() {
      ...
      return _react2['default'].createElement('div', { dangerouslySetInnerHTML: this.renderedMarkdown() });
    }
  }], [{
    key: 'propTypes',
    value: {
