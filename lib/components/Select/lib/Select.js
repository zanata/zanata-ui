...
var _cssDefaultCss = require('../css/default.css');

var _cssDefaultCss2 = _interopRequireDefault(_cssDefaultCss);
...
var Select = React.createClass({
   ...
   */
	...
	render: function render() {
		var selectClass = cx('Select', 'posr', this.props.className, {
		...
		var selectControlClasses = cx('posr', 'bgcwhite', 'bgcwhite', 'pl1/2', 'pr1&1/2');
		var value = [];
		if (this.props.multi) {
		...
		var clear = this.props.clearable && this.state.value && !this.props.disabled ? React.createElement(
			'button',
			{ className: 'posa r1 t0 b0 w1 h1&1/2 dfx aic jcc csec50', title: this.props.multi ? this.props.clearAllText : this.props.clearValueText, 'aria-label': this.props.multi ? this.props.clearAllText : this.props.clearValueText, onMouseDown: this.clearValue, onClick: this.clearValue },
			React.createElement(Icon, { name: 'cross', size: 's0' })
		) : null;
		...
		if (this.state.isOpen) {
			...
			menu = React.createElement(
				'div',
				{ ref: 'selectMenuContainer', className: 'Select-menu-outer bdrs1/4 bgcwhite bd bdcsec20 posa z4 w100p' },
				React.createElement(
					'div',
					menuProps,
					this.buildMenu()
		...
		return React.createElement(
			...
			React.createElement(
				'div',
				{ className: selectControlClasses, ref: 'control', onKeyDown: this.handleKeyDown, onMouseDown: this.handleMouseDown, onTouchEnd: this.handleMouseDown },
				value,
				input,
				React.createElement(
					'button',
					{ className: 'posa r0 t0 b0 w1 dfx aic jcc cpri', onMouseDown: this.handleMouseDownOnArrow },
					React.createElement(Icon, { name: 'chevron-down', size: 's1' })
				),
				loading,
				clear
			),
