...
const OverlayTrigger = React.createClass({
  propTypes: {
    ...
    /**
     * The initial visibility state of the Overlay, for more
     * nuanced visibility control consider using the
     * Overlay component directly.
     */
  ...
  componentWillMount () {
    this.handleMouseOver = this.handleMouseOverOut.bind(
      null, this.handleDelayedShow)
    this.handleMouseOut = this.handleMouseOverOut.bind(
      null, this.handleDelayedHide)
  },
  ...
  render () {
    ...
    props.onClick = createChainedFunction(
      triggerProps.onClick, this.props.onClick)

    if (isOneOf('click', this.props.trigger)) {
      props.onClick = createChainedFunction(
        this.toggle, props.onClick)
    }
    ...
    if (isOneOf('hover', this.props.trigger)) {
      ...
      props.onMouseOver = createChainedFunction(
        this.handleMouseOver, this.props.onMouseOver, triggerProps.onMouseOver)
      props.onMouseOut = createChainedFunction(
        this.handleMouseOut, this.props.onMouseOut, triggerProps.onMouseOut)
      /* eslint-enable max-len */
    }

    if (isOneOf('focus', this.props.trigger)) {
      props.onFocus = createChainedFunction(
        this.handleDelayedShow, this.props.onFocus, triggerProps.onFocus)
      props.onBlur = createChainedFunction(
        this.handleDelayedHide, this.props.onBlur, triggerProps.onBlur)
    }
